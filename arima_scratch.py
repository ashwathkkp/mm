...
Original file is located at
    https://colab.research.google.com/drive/1_wM2HvhYbQqG2Ou8Xwe-rrZmgZ4KM6LU
"""
...
df = pd.read_csv('/content/gdrive/MyDrive/Colab Notebooks/df.csv',parse_dates=True,index_col='date')
